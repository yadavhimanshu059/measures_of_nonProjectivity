...
from random_trees_v1.0 import *

results1=open('all_measures_random_v2.0_18thoct_hi.csv','a')               
results2=open('range_measures__random_v2.0_18thoct_hi.csv','a')
results3=open('arity_hist_random_v2.0_18thoct_hi.csv','a')
results4=open('projdegree_hist_random_v2.0_18thoct_hi.csv','a')
results5=open('gapdegree_hist_random_v2.0_18thoct_hi.csv','a')
...
for i in ud_files:                                       # reads file of each language one by one
    if 'hi' in str(i):
        ...
        for sentence in sentences[0:]:
            ...
            generate = Random_base_v1(tree)
            ls_random = generate.gen_random(num_cross_tree)
            if ls_random:
                for treex in ls_random:
                    root=1000
