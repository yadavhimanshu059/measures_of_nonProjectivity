...
for i in ud_files:                                       # reads file of each language one by one
    if 'ar' in str(i):                                   # selects the language from the corpus
        ...
        for sentence in sentences[0:]:
            ...
            if sent_id>1:
                ...
                n=len(tree.edges)
                if n<12:
                    get = Compute_measures(tree)        # inititate object for computing measures for the real tree
                    num_cross_real=0
                    ...
                    ls_random = generate.gen_random(num_cross_real)     # stores the list of randomly generated trees for given conditions  
                    if ls_random:                                      
                        treex=ls_random[0]                              # selects only one tree from the list if there are more than one   
                        print(ls_random)
                        root=1000
                        find=Compute_measures_rand(treex,root)          # initiates the object variable for computing the measures in random tree 
                        ...
                        for edgex in treex.edges:
                            ...
                            results1 = open('all_measures_real_random_shorts_ar.csv','a')
                            ...
                            results1.close()
                        # Computes measures for the real language tree
                        ...
                        for edgey in tree.edges:
                            ...
                            results2 = open('all_measures_real_random_shorts_ar.csv','a')
